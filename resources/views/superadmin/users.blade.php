<!DOCTYPE html> 
	...
	<body>
		<div class="top_head_S">
			...
			<a href="{{ route('signout') }}" class="sign_out">Signout</a>
		</div>
		<div class="container">
						...
						<table id="example" class="display table custom-table responsive nowrap" >
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="{{ route('delete-admin', ['id' => $user->id]) }}" class="delete-btn" onclick="return confirm('Are you sure you want to delete this admin?');">Delete</a>
										<a href="{{ route('change-password', ['id' => $user->id]) }}" class="change-psd-btn">Change Password</a>
									</td>
								</tr>
								@endforeach 
							</tbody>
