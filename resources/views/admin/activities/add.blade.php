            ...
            <div class="col-8 offset-md-2 form_v">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('save-activity') }}" method="POST" id="Login" enctype="multipart/form-data">
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    {{-- <div class="col-lg-12 col-md-12 floating-label-wrap">
                                        <input type="text" class="date floating-label-field floating-label-field--s1 name" name="date" placeholder="Start Date*" required autocomplete="off" value="{{ old('date') }}">
                                        <label for="" class="floating-label">Date*</label>
                                    </div> --}}
                                    <!-- In case we will need to add date in future -->
