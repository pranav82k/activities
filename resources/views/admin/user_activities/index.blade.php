	...
	<div class="page-breadcrumb">
        <div class="row">
            ...
            <div class="col-8 align-self-center">
                <a class="btn btn-primary float-right btn-view-all" href="{{ route('add-user-activity', ['user_id' => $activities->id]) }}" role="button"><i data-feather="plus" class="width15"></i> Add User Activity</a>
            </div>
		...
		<div class="row">
			<div class="col-12">
				<div class="card">
				    <div class="card-body">
				        <div class="mb-4">
				            <h4 class="card-title">User Activities - {{ $activities->name}}</h4>
								...
								<tbody>
									...
									<tr>
										...
										<td class="border-top-0 px-2 py-4">
											<a href="{{ route('edit-user-activity', ['id' => $activity->id])  }}" class="change-psd-btn"><i class="fas fa-edit"></i></a>
											<a href="javascript:void(0);" data-url="{{ route('delete-user-activity', ['id' => $activity->id])  }}" class="change-psd-btn px-2 delete_user_activity" ><i class="fas fa-trash"></i></a>
										</td>
									</tr>
									@endforeach 
								</tbody>
